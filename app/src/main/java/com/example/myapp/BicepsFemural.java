...
public class BicepsFemural extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_biceps_femural);
        ...
        link11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gotoUrl("https://www.youtube.com/watch?v=n5WDXD_mpVY");
            }
        });
        ...
        link22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.youtube.com/watch?v=Orxowest56U");
            }
        });
